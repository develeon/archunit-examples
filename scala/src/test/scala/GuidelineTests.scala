...
object GuidelineTests {
  ...
  private val `classes in domain can only access classes in domain itself`
    : ArchRule =
  ...
  private val `classes should reside in a given package`: ArchRule =
    classes.that
      ...
      .should
      .resideInAnyPackage("..repository..", "..repositories..")
      .andShould()
      .beInterfaces()
  ...
  private def restrictClassDependencyOnItselfAndOnAuthorizedPackages(
    classesInPackages: List[String],
    authorizedPackages: List[String] = List.empty
  ): ArchRule =
    classes()
      .that()
      .resideInAnyPackage(classesInPackages: _*)
      .should()
      .onlyDependOnClassesThat()
      .resideInAnyPackage(
        classesInPackages ::: authorizedPackages ::: systemPackages: _*
      )
}
